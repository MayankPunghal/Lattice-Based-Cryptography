...
class Ntru:
    ...
    def encrypt(self, message, randPol):
        if self.h != None:
            ...
            print
            "Cannot Encrypt Message Public Key is not set!"
            print
            "Cannot Set Public Key manually or Generate it"
